...
use std::{fmt::{self, Debug}, sync::atomic::{AtomicBool, Ordering}};
    ...
    R: Send,
{
    ...
    fn split_at(self, index: usize) -> (Self, Self, Self::Reducer) {
        ...
        (
            ScanConsumer{base: left, scan_op: self.scan_op, identity: self.identity, full: self.full},
            ScanConsumer{base: right, scan_op: self.scan_op, identity: self.identity, full: self.full},
            reducer,
        )
    }
